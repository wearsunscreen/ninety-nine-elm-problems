...
test =
    List.length
        <| List.filter ((==) False)
            [ getInternals Empty == []
            , getInternals (Node 1 Empty Empty) == [ 1 ]
            , List.sort (getInternals (Node 1 (Node 2 Empty Empty) Empty)) == [ 1, 2 ]
            , List.sort (getInternals (Node 1 (Node 2 Empty Empty) (Node 0 Empty Empty))) == [0, 1, 2]
            , List.sort (getInternals (Node "A" (Node "B" Empty Empty) (Node "C" Empty Empty))) == []
            , List.sort
                (getInternals
                    (Node 1
